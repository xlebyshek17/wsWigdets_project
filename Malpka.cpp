...
MyFrame::MyFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_gauge->SetMinSize( wxSize( 240,20 ) );

	bSizer3->Add( m_gauge, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	...
	m_scrollBar->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( MyFrame::m_scrollBarOnScrollChanged ), NULL, this );
